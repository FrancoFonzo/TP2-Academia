            ...
            public int Legajo {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Legajo\' in table \'Curso\' is DBNull.", e);
                    }
                }
                set {
...
ORDER BY Curso.ID";
        ...
        public virtual int Fill(DataSet1.CursoDataTable dataTable, int Param1) {
        ...
        public virtual DataSet1.CursoDataTable GetData(int Param1) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(Param1));
